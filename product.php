    ...
    padding: 12px !important;
        ...
        <!-- section 2 -->
				...
				<?php 
					...
					$first_four = substr($product_dec, 0, 4);
					$pParts = explode('##', $product_dec);
					$product_link = $pParts[0];
					$product_link_name = $pParts[1];
				?>
    ...
    <section class="section2">
        <div class="container" bis_skin_checked="1">
            ...
            <div class="title-new" bis_skin_checked="1">
				...
				<form style="display: flex; justify-content: center;" class="product-form" data-product="<?= encrypt($product['id']); ?>">
                    <?php if ($first_four == 'http') { ?>
						<div class="col-md-12 d-flex justify-content-center"><a href="<?php echo $product_link; ?>" target="_blank" class="btn btn-lg btn-success btn-lock"><?php echo $product_link_name; ?></a></div>
					<? } else { ?>
						<div class="col-md-12 d-flex justify-content-center"><button type="button" class="btn btn-lg btn-success btn-lock add-to-cart-btn">Add To Cart + $<?= $product['price']; ?> <?= $badge_text; ?></button></div>
					<?php } ?>
                </form>
          ...
          <p><?= $product['long_product_description']; ?></p>
                <form style="display: flex; justify-content: center;" <?php if ($first_four == 'http') { } else { ?>class="product-form" data-product="<?= encrypt($product['id']); ?>"<?php } ?>>
                    <?php 
					if ($first_four == 'http') { ?>
						<div class="col-md-12 d-flex justify-content-center"><a href="<?php echo $product_link; ?>" target="_blank" class="btn btn-lg btn-success btn-lock"><?php echo $product_link_name; ?></a></div>
					<? } else { ?>
